...
-- カラム: id, word, meaning, synonyms, example_1, example_2, created_at

insert into public.english_vocab (word, meaning, synonyms, example_1, example_2)
values (
  'leave sth/sb alone',
  '〜を放っておく',
  'ignore, let be, leave it',
